$(document).ready(function(){
	...
	if(widthwin<=767){
		//$("#wrraper #service #content ul").attr('data-flickity','{ "contain": true, "pageDots": false, "rightToLeft": true, "prevNextButtons": false, "freeScroll": true, "cellAlign": "left", "groupCells": 1 }');
